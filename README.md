...
- :rocket: Get it here: [Instagram Downloader](https://serp.ly/instagram-downloader)
- :new: Latest release: [GitHub Releases](https://github.com/serpapps/instagram-downloader/releases/latest)
- :question: Help center: [SERP Help](https://help.serp.co/en/)
- :beetle: Report bugs: [GitHub Issues](https://github.com/serpapps/instagram-downloader/issues)
- :bulb: Request features: [Feature Requests](https://github.com/serpapps/instagram-downloader/issues)

## Preview

![Instagram Downloader workflow preview](https://raw.githubusercontent.com/serpapps/instagram-downloader/refs/heads/main/assets/workflow-preview.webp)

## Table of Contents

- [Why Instagram Downloader](#why-instagram-downloader)
- [Features](#features)
- [How It Works](#how-it-works)
- [Step-by-Step Tutorial: How to Download Content from Instagram](#step-by-step-tutorial-how-to-download-content-from-instagram)
...
2. Open Instagram and navigate to a post, Reel, Story, profile, or feed view.
3. Let the media load so the extension can detect what is visible.
4. Use the in-page buttons or open the extension popup.
...
1. Install Instagram Downloader from the latest GitHub release.
2. Sign in to Instagram if the content you want requires login access.
3. Open the Reel, post, Story, or profile section you want to save from.
4. Scroll until the media you want is fully visible on the page.
...
Start here: [https://serp.ly/instagram-downloader](https://serp.ly/instagram-downloader)

## Installation Instructions

1. Open the latest release page:
   [https://github.com/serpapps/instagram-downloader/releases/latest](https://github.com/serpapps/instagram-downloader/releases/latest)
2. Download the extension build for your browser.
3. Install the extension.
4. Open Instagram and navigate to the content you want to save.
5. Use the extension controls to download visible media or captions.
